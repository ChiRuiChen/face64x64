...
module sigmoid_ss_ap_fixed_ap_fixed_sigmoid_config26_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
sigmoid_ss_ap_fixed_ap_fixed_sigmoid_config26_s_sigmoid_tIfE #(
    .DataWidth( 10 ),
    .AddressRange( 1024 ),
    .AddressWidth( 10 ))
sigmoid_table1_U(
...
assign icmp_ln158_fu_135_p2 = ((i_0_reg_124 == 3'd4) ? 1'b1 : 1'b0);
...
endmodule //sigmoid_ss_ap_fixed_ap_fixed_sigmoid_config26_s
